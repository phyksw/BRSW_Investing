  ...
  <nav class="nav">
    <div class="container nav-inner">
      ...
      <div class="nav-links">
        ...
        <a href="https://kswterminal.netlify.app/sectors/${currentSlug}.html" target="_blank" rel="noopener" style="color:var(--mango-deep);font-weight:700">v3 상세 ↗</a>
      </div>
    </div>
  </nav>`;
...
${s.stocks.map(st => `        <div class="stat-card ${st.color}">
  ...
  <section style="padding-bottom:80px">
    <div class="container-narrow" style="text-align:center">
      ...
      <div class="hero-cta">
        <a class="btn btn-primary" href="https://kswterminal.netlify.app/sectors/${s.slug}.html" target="_blank" rel="noopener">${s.name} 전체 분석 →</a>
